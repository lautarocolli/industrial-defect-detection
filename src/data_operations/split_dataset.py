...
for img_path in images_dir.glob("*.jpg"):
    class_name = img_path.stem.split("_")[0]  # adjust if naming differs
...
for split in split_map:
    ...
    ann_dir = split_dir / split / "ANNOTATIONS"
    ...
    # Check that image and annotation match
